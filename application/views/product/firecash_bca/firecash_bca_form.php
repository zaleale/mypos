...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?= ucfirst($page) ?> Firecash BCA</h3>
            <div class="pull-right">
                <a href="<?= site_url('firecash_bca') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <!-- <?php echo form_open_multipart('firecash_bca/process') ?> -->
                    <form action="<?= site_url('firecash_bca/process') ?>" method="post">
                        <form>
                            <div class="form-group">
                                <input type="hidden" name="id" value="<?= $row->firecash_bca_id ?>">
