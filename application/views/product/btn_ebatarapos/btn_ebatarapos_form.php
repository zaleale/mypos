...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?= ucfirst($page) ?> BTN e-Batara Pos </h3>
            <div class="pull-right">
                <a href="<?= site_url('btn_ebatarapos') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <?php echo form_open_multipart('btn_ebatarapos/process') ?>
                    <!-- <form action="<?= site_url('btn_ebatarapos/process') ?>" method="post"> -->
                    <form>
                        <div class="form-group">
                            <input type="hidden" name="id" value="<?= $row->btn_ebatarapos_id ?>">
