...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?= ucfirst($page) ?> Qposin Aja </h3>
            <div class="pull-right">
                <a href="<?= site_url('qposin_aja') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <?php echo form_open_multipart('qposin_aja/process') ?>
                    <!-- <form action="<?= site_url('qposin_aja/process') ?>" method="post"> -->
                    <form>
                        <div class="form-group">
                            <input type="hidden" name="id" value="<?= $row->qposin_aja_id ?>">
