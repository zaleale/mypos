...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?= ucfirst($page) ?> Tranfast</h3>
            <div class="pull-right">
                <a href="<?= site_url('tranfast') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <!-- <?php echo form_open_multipart('tranfast/process') ?> -->
                    <form action="<?= site_url('tranfast/process') ?>" method="post">
                        <form>
                            <div class="form-group">
                                <input type="hidden" name="id" value="<?= $row->tranfast_id ?>">
