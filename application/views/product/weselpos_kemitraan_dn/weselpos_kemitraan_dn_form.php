...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?= ucfirst($page) ?> Weselpos Kemitraan Dalam Negeri </h3>
            <div class="pull-right">
                <a href="<?= site_url('weselpos_kemitraan_dn') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <?php echo form_open_multipart('weselpos_kemitraan_dn/process') ?>
                    <!-- <form action="<?= site_url('weselpos_kemitraan_dn/process') ?>" method="post"> -->
                    <form>
                        <div class="form-group">
                            <input type="hidden" name="id" value="<?= $row->weselpos_kemitraan_dn_id ?>">
